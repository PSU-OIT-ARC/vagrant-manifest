...
file { '/etc/pki/rpm-gpg/RPM-GPG-KEY-CentOS-5':
  ...
  source => '/vagrant/manifests/gpgkey/rpm-gpg/RPM-GPG-KEY-CentOS-5',
  # content  => '{md5}5f7bafa185a848e2f689dba1918dcf64',
  # ctime    => 'Mon Jul 22 08:53:11 -0700 2013',
  group    => '0',
  mode     => '644',
  # mtime    => 'Mon Jul 22 08:53:11 -0700 2013',
  owner    => '0',
  selrange => 's0',
  selrole  => 'object_r',
  seltype  => 'cert_t',
...
file { '/etc/pki/rpm-gpg/RPM-GPG-KEY-CentOS-6':
  ...
  source => '/vagrant/manifests/gpgkey/rpm-gpg/RPM-GPG-KEY-CentOS-6',  
  # content  => '{md5}e8e57fd1a55dc5c6d82e60a444781b96',
  # ctime    => 'Mon Jul 22 07:25:04 -0700 2013',
  group    => '0',
  mode     => '644',
  # mtime    => 'Mon Feb 25 00:57:43 -0800 2013',
  owner    => '0',
  selrange => 's0',
  selrole  => 'object_r',
  seltype  => 'cert_t',
...
file { '/etc/pki/rpm-gpg/RPM-GPG-KEY-CentOS-Debug-6':
  ...
  source => '/vagrant/manifests/gpgkey/rpm-gpg/RPM-GPG-KEY-CentOS-Debug-6',
  # content  => '{md5}dcb83b1f06c22b0a859bd968057adec3',
  # ctime    => 'Mon Jul 22 07:25:04 -0700 2013',
  group    => '0',
  mode     => '644',
  # mtime    => 'Mon Feb 25 00:57:43 -0800 2013',
...
file { '/etc/pki/rpm-gpg/RPM-GPG-KEY-CentOS-Security-6':
  ...
  source => '/vagrant/manifests/gpgkey/rpm-gpg/RPM-GPG-KEY-CentOS-Security-6',
  # content  => '{md5}c82b563131e7de2b6e348e5ef270f5db',
  # ctime    => 'Mon Jul 22 07:25:04 -0700 2013',
  group    => '0',
  mode     => '644',
  # mtime    => 'Mon Feb 25 00:57:43 -0800 2013',
...
file { '/etc/pki/rpm-gpg/RPM-GPG-KEY-CentOS-Testing-6':
  ...
  source => '/vagrant/manifests/gpgkey/rpm-gpg/RPM-GPG-KEY-CentOS-Testing-6',
  # content  => '{md5}a23fda2a6a2cabd0efa86c628c65e7c6',
  # ctime    => 'Mon Jul 22 07:25:04 -0700 2013',
  group    => '0',
  mode     => '644',
  # mtime    => 'Mon Feb 25 00:57:43 -0800 2013',
...
file { '/etc/pki/rpm-gpg/RPM-GPG-KEY-dell':
  ...
  source => '/vagrant/manifests/gpgkey/rpm-gpg/RPM-GPG-KEY-dell',
  # content  => '{md5}dc53b926df12873b42ca96e95d7be8e9',
  # ctime    => 'Mon Jul 22 08:53:21 -0700 2013',
  group    => '0',
  mode     => '644',
  # mtime    => 'Mon Jul 22 08:53:21 -0700 2013',
  owner    => '0',
  selrange => 's0',
  selrole  => 'object_r',
  seltype  => 'cert_t',
...
file { '/etc/pki/rpm-gpg/RPM-GPG-KEY-ELGIS':
  ...
  source => '/vagrant/manifests/gpgkey/rpm-gpg/RPM-GPG-KEY-ELGIS',
  # content  => '{md5}2ff05a9d5450ea79c9fb13944512d287',
  # ctime    => 'Mon Jul 22 08:53:16 -0700 2013',
  group    => '0',
  mode     => '644',
  # mtime    => 'Mon Jul 22 08:53:16 -0700 2013',
  owner    => '0',
  selrange => 's0',
  selrole  => 'object_r',
  seltype  => 'cert_t',
...
file { '/etc/pki/rpm-gpg/RPM-GPG-KEY-endpoint':
  ...
  source => '/vagrant/manifests/gpgkey/rpm-gpg/RPM-GPG-KEY-endpoint',
  # content  => '{md5}4293fcdb75af617a6b73777fb7e51483',
  # ctime    => 'Mon Jul 22 08:49:52 -0700 2013',
  group    => '0',
  mode     => '644',
  # mtime    => 'Mon Jul 22 08:49:52 -0700 2013',
  owner    => '0',
  selrange => 's0',
  selrole  => 'object_r',
  seltype  => 'cert_t',
...
file { '/etc/pki/rpm-gpg/RPM-GPG-KEY-EPEL-5':
  ...
  source => '/vagrant/manifests/gpgkey/rpm-gpg/RPM-GPG-KEY-EPEL-5',
  # content  => '{md5}0466c259781def56dafe0a2cdc9de0c5',
  # ctime    => 'Mon Jul 22 08:53:11 -0700 2013',
  group    => '0',
  mode     => '644',
  # mtime    => 'Mon Jul 22 08:53:11 -0700 2013',
...
file { '/etc/pki/rpm-gpg/RPM-GPG-KEY-EPEL-6':
  ...
  source => '/vagrant/manifests/gpgkey/rpm-gpg/RPM-GPG-KEY-EPEL-6',
  # content  => '{md5}d865e6b948a74cb03bc3401c0b01b785',
  # ctime    => 'Mon Jul 22 08:49:52 -0700 2013',
  group    => '0',
  mode     => '644',
  # mtime    => 'Mon Jul 22 08:49:52 -0700 2013',
...
file { '/etc/pki/rpm-gpg/RPM-GPG-KEY-jpackage':
  ...
  source => '/vagrant/manifests/gpgkey/rpm-gpg/RPM-GPG-KEY-jpackage',
  # content  => '{md5}f9d4e3ad4e65ca266cbdd6c0da7c819c',
  # ctime    => 'Mon Jul 22 08:49:52 -0700 2013',
  group    => '0',
  mode     => '644',
  # mtime    => 'Mon Jul 22 08:49:52 -0700 2013',
...
file { '/etc/pki/rpm-gpg/RPM-GPG-KEY-libsmbios':
  ...
  source => '/vagrant/manifests/gpgkey/rpm-gpg/RPM-GPG-KEY-libsmbios',
  # content  => '{md5}8ae5b0a2505169be5180889e0038d82f',
  # ctime    => 'Mon Jul 22 08:49:52 -0700 2013',
  group    => '0',
  mode     => '644',
  # mtime    => 'Mon Jul 22 08:49:52 -0700 2013',
...
file { '/etc/pki/rpm-gpg/RPM-GPG-KEY-NewRelic':
  ...
  source => '/vagrant/manifests/gpgkey/rpm-gpg/RPM-GPG-KEY-NewRelic',
  # content  => '{md5}be9704aa1e7001d855a60c4c05d7598b',
  # ctime    => 'Mon Jul 22 08:55:31 -0700 2013',
  group    => '0',
  mode     => '644',
  # mtime    => 'Mon Jul 22 08:55:31 -0700 2013',
  owner    => '0',
  selrange => 's0',
  selrole  => 'object_r',
  seltype  => 'cert_t',
...
file { '/etc/pki/rpm-gpg/RPM-GPG-KEY-passenger':
  ...
  source => '/vagrant/manifests/gpgkey/rpm-gpg/RPM-GPG-KEY-passenger',
  # content  => '{md5}16c41925142c06382e9b32a724ed8ef4',
  # ctime    => 'Mon Jul 22 08:53:16 -0700 2013',
  group    => '0',
  mode     => '644',
  # mtime    => 'Mon Jul 22 08:53:16 -0700 2013',
...
file { '/etc/pki/rpm-gpg/RPM-GPG-KEY-pdxbuild':
  ...
  source => '/vagrant/manifests/gpgkey/rpm-gpg/RPM-GPG-KEY-pdxbuild',
  # content  => '{md5}b97eb5c243d023e11f1b4d91d6257cc0',
  # ctime    => 'Mon Jul 22 08:55:43 -0700 2013',
  group    => '0',
  mode     => '644',
  # mtime    => 'Mon Jul 22 08:55:43 -0700 2013',
  owner    => '0',
  selrange => 's0',
  selrole  => 'object_r',
  seltype  => 'cert_t',
...
file { '/etc/pki/rpm-gpg/RPM-GPG-KEY-PGDG':
  ...
  source => '/vagrant/manifests/gpgkey/rpm-gpg/RPM-GPG-KEY-PGDG',
  # content  => '{md5}42bc0862a12c318f4267711c04030b3d',
  # ctime    => 'Mon Jul 22 08:55:43 -0700 2013',
  group    => '0',
  mode     => '644',
  # mtime    => 'Mon Jul 22 08:55:43 -0700 2013',
...
file { '/etc/pki/rpm-gpg/RPM-GPG-KEY-PGDG-91':
  ...
  source => '/vagrant/manifests/gpgkey/rpm-gpg/RPM-GPG-KEY-PGDG-91',
  # content  => '{md5}78b5db170d33f80ad5a47863a7476b22',
  # ctime    => 'Mon Jul 22 08:55:41 -0700 2013',
  group    => '0',
  mode     => '644',
  # mtime    => 'Mon Jul 22 08:55:41 -0700 2013',
  owner    => '0',
  selrange => 's0',
  selrole  => 'object_r',
  seltype  => 'cert_t',
...
file { '/etc/pki/rpm-gpg/RPM-GPG-KEY-puppetlabs':
  ...
  source => '/vagrant/manifests/gpgkey/rpm-gpg/RPM-GPG-KEY-puppetlabs',
  # content  => '{md5}339014f9b0517552c232501438f40b3d',
  # ctime    => 'Mon Jul 22 08:55:29 -0700 2013',
  group    => '0',
  mode     => '644',
  # mtime    => 'Mon Jul 22 08:55:29 -0700 2013',
  owner    => '0',
  selrange => 's0',
  selrole  => 'object_r',
  seltype  => 'cert_t',
...
file { '/etc/pki/rpm-gpg/RPM-GPG-KEY-remi':
  ...
  source => '/vagrant/manifests/gpgkey/rpm-gpg/RPM-GPG-KEY-remi',
  # content  => '{md5}3abb4e5a7b1408c888e19f718c012630',
  # ctime    => 'Mon Jul 22 08:49:52 -0700 2013',
  group    => '0',
  mode     => '644',
  # mtime    => 'Mon Jul 22 08:49:52 -0700 2013',
...
file { '/etc/pki/rpm-gpg/RPM-GPG-KEY-rpmforge-dag':
  ...
  source => '/vagrant/manifests/gpgkey/rpm-gpg/RPM-GPG-KEY-rpmforge-dag',
  # content  => '{md5}a44f72c72b873d0f8f3021690bb3e52f',
  # ctime    => 'Mon Jul 22 08:53:11 -0700 2013',
  group    => '0',
  mode     => '644',
  # mtime    => 'Mon Jul 22 08:53:11 -0700 2013',
...
file { '/etc/pki/rpm-gpg/RPM-GPG-KEY-spacewalk-2012':
  ...
  source => '/vagrant/manifests/gpgkey/rpm-gpg/RPM-GPG-KEY-spacewalk-2012',
  # content  => '{md5}586b79b66ac3b5b0f4671de8ea0ccab2',
  # ctime    => 'Mon Jul 22 08:53:14 -0700 2013',
  group    => '0',
  mode     => '644',
  # mtime    => 'Mon Jul 22 08:53:14 -0700 2013',
  owner    => '0',
  selrange => 's0',
  selrole  => 'object_r',
  seltype  => 'cert_t',
...
file { '/etc/pki/rpm-gpg/RPM-GPG-KEY-splunk':
  ...
  source => '/vagrant/manifests/gpgkey/rpm-gpg/RPM-GPG-KEY-splunk',
  # content  => '{md5}6c0ac97db3db568e51562a968e8a24fe',
  # ctime    => 'Mon Jul 22 08:55:34 -0700 2013',
  group    => '0',
  mode     => '644',
  # mtime    => 'Mon Jul 22 08:55:34 -0700 2013',
  owner    => '0',
  selrange => 's0',
  selrole  => 'object_r',
  seltype  => 'cert_t',
...
file { '/etc/pki/rpm-gpg/RPM-GPG-KEY-unixteam-builder':
  ...
  source => '/vagrant/manifests/gpgkey/rpm-gpg/RPM-GPG-KEY-unixteam-builder',
  # content  => '{md5}35eb1ae48b9c3c2cd8b4abe5d3ece82c',
  # ctime    => 'Wed Jul 31 17:17:19 -0700 2013',
  group    => '0',
  mode     => '644',
  # mtime    => 'Wed Jul 31 17:17:19 -0700 2013',
  owner    => '0',
  selrange => 's0',
  selrole  => 'object_r',
  seltype  => 'cert_t',
...
file { '/etc/pki/rpm-gpg/RPM-GPG-KEY-VARNISH':
  ...
  source => '/vagrant/manifests/gpgkey/rpm-gpg/RPM-GPG-KEY-VARNISH',
  # content  => '{md5}06235a3b8e0633dd7715ac405a20d261',
  # ctime    => 'Mon Jul 22 08:56:36 -0700 2013',
  group    => '0',
  mode     => '644',
  # mtime    => 'Mon Jul 22 08:56:36 -0700 2013',
  owner    => '0',
  selrange => 's0',
  selrole  => 'object_r',
  seltype  => 'cert_t',
...
file { '/etc/pki/rpm-gpg/RPM-GPG-KEY-vmwaretools':
  ...
  source => '/vagrant/manifests/gpgkey/rpm-gpg/RPM-GPG-KEY-vmwaretools',
  group    => '0',
  mode     => '644',
  owner    => '0',
  selrange => 's0',
...
file { '/etc/pki/rpm-gpg/RPM-GPG-unixteam-builder':
  ...
  source => '/vagrant/manifests/gpgkey/rpm-gpg/RPM-GPG-unixteam-builder',
  group    => '0',
  mode     => '644',
  owner    => '0',
  selrange => 's0',
